// Maps country names to continents.
// Covers the most common travel destinations — unmapped countries default to "Other".
...
const COUNTRY_TO_CONTINENT: Record<string, string> = {
  ...
  'Madagascar': 'Africa', 'Malawi': 'Africa', 'Mali': 'Africa', 'Morocco': 'Africa',
  ...
  'DR Congo': 'Africa', 'Ivory Coast': 'Africa', 'Liberia': 'Africa',
  ...
  'UAE': 'Asia', 'United Arab Emirates': 'Asia', 'Uzbekistan': 'Asia',
  ...
  'United Kingdom': 'Europe', 'UK': 'Europe', 'Vatican City': 'Europe',
  ...
  'Saint Vincent': 'North America', 'Trinidad and Tobago': 'North America',
...
export function getContinentsFromCountries(countries: string[]): Set<string> {
