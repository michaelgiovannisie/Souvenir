      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-xs font-medium text-gray-600 bg-gray-100 border-0 rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-2 focus:ring-brand-500 cursor-pointer"
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="0.00"
                required
                className="w-full px-3 py-2 text-sm border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
              />
            </div>
                ...
                {!isCollapsed && (
                  <div className="border-t border-gray-100 divide-y divide-gray-100">
                    {items.map((expense) => (
                      <div
                        key={expense.id}
                        className="flex items-center justify-between px-4 py-2.5 group hover:bg-gray-50 transition-colors"
                      >
