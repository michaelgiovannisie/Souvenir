...
function MemoriesPageSkeleton() {
  return (
    <div className="space-y-3">
      {[...Array(5)].map((_, i) => (
        <div key={i} className="h-36 bg-gray-100 dark:bg-gray-700 rounded-2xl animate-pulse" />
      ))}
    </div>
  )
}
      ...
      <div className="flex-1 pb-8">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 hover:shadow-md hover:border-gray-300 dark:border-gray-600 transition-all duration-200">
          ...
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <Link
              to={`/trips/${m.tripId}`}
              className="flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-900/50 hover:bg-brand-50 border border-gray-200 dark:border-gray-700 hover:border-brand-200 text-xs text-gray-500 dark:text-gray-400 hover:text-brand-600 transition-colors"
  ...
  return (
    <div className="flex items-center gap-3 py-2">
      ...
      <div className="flex items-center gap-3 flex-1">
        <span className="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">{year}</span>
...
function EmptyState({ hasSearch }: { hasSearch: boolean }) {
  ...
  return (
    <div className="text-center py-32">
      ...
      <h3 className="font-semibold text-gray-900 dark:text-white mb-2">No memories yet</h3>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {trips.length > 1 && (
              <select
                ...
                className="px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400 focus:border-transparent dark:focus:border-transparent transition-shadow"
              >
            ...
            {hasActiveFilter && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
